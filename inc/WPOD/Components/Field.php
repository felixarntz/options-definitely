...
class Field extends ComponentBase
{
  ...
  public function render( $args = array() )
  {
    ...
    {
      wpod_doing_it_wrong( __METHOD__, sprintf( __( 'There type for field %s is not supported. Either specify a supported type or provide a valid callback function instead.', 'wpod' ), $this->slug ), '1.0.0' );
    }
  }
  ...
  private function get_supported_types()
  {
    return array(
      'checkbox',
      'select',
